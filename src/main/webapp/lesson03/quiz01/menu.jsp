...
<nav class="bg-danger menu d-flex algin-items-center">
	<ul class="nav nav-fill w-100">
		...
		<li class="nav-item"><a href="/lesson03/quiz01/channel.jsp?category=영화" class="nav-link text-white">영화</a></li>
		<li class="nav-item"><a href="/lesson03/quiz01/channel.jsp?category=스포츠" class="nav-link text-white">스포츠</a></li>
	</ul>
</nav>